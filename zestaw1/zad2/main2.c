...
int main()
{
    ...
    if(!handle)
    {
        printf("Oppening library error.\n");
        return 1;
    }

    struct tab * (* createTable)() = (struct tab * (*)())dlsym(handle,"createTable");
    void (* freeTab)() = (void (*)())dlsym(handle, "freeTab");
    void (* countWords)() = (void (*)())dlsym(handle, "countWords");
    char * (* getBlock)() = (char * (*)())dlsym(handle, "getBlock");
    void (* deleteBlock)() = (void (*)())dlsym(handle, "deleteBlock");
    
    if(dlerror() != NULL)
    {
        printf("Oppening library function error.\n");
        return 1;
    }
